...
export default function Burger() {
  ...
  let ButtonComponent;
  const largerScreen = screenWidth >= 834;
  ...
  return (
    <>
      ...
      {/* <div className="flex flex-col justify-between absolute top-0 left-0 w-80 h-screen min-h-full bg-white transition-transform duration-500 transform -translate-x-full p-6 z-50 bg-grd"></div> */}
