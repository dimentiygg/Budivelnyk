...
export default function NavBar() {
  ...
  return (
    <header className="fixed top-0 z-[9999] bg-wht w-full shadow-hd">
      <div className="sm:container sm:max-w-none w-full flex justify-between max-w-none pt-8 pb-4 md:p-0 md:pl-12 lg:pl-20 lg:w-[1440px] lg:mx-auto lg:left-auto lg:right-auto">
