  ...
  return (
    <section className="relative pt-[20px] pb-12 font-inter md:pb-0 md:mb-24 md:h-[475px] lg:h-[598px] lg:mb-[144px]  lg:pt-[48px]">
      <div className="lg:mx-auto lg:w-[1280px] lg:px-24 ">
        ...
        <div className="sm:px-4  max-w-none md:w-[474px] md:ml-6 order-1 lg:p-0 ">
          <p className="mb-6 font-semibold text-base tracking-small uppercase text-orn2 lg:text-lg">
            новинки
          </p>
          <h2 className="mb-12 font-bold text-4xl leading-[125%] text-grd md:text-[40px] md:w-[451px] lg:text-[48px]">
